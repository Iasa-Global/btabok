...
[Why is a Business Model Important to Architects?](#why-is-a-business-model-important-to-architects)

[Approaches to Business Models](#approaches-to-business-models)
...
[Anchor Competitive Necessity](#anchor-competitive-necessity)

[Approaches to Markets and Products or Services](#approaches-to-markets-and-products-or-services)

[The Basic Business Model](#the-basic-business-model)
...
[Business Model Patterns](#business-model-patterns)

[Unbundled](#unbundled)

[The Long Tail](#the-long-tail)

[Multi-Sided Platform](#multi-sided-platform)

[Free as a Business Model](#free-as-a-business-model)
...
Markets come in four types: Classical, Adaptive, Shaping, and Visionary[^1]. The market type is determined by the degree to which participants can predict the behavior of customers and competitors and the degree to which the company and its competitors can influence that behavior.

[^1]: Reeves, Love, and Tillmann, “Your Strategy Needs a Strategy”, *Harvard Business Review*, September, 2012, pp 76-83.
...
![The "bounded box"](media/a4a3afe5f1ed2ef6ce53e357e5bbefde.png)
...
If a segmented marked is selected, there is much more work to do. In *Business Model Generation*[^4], Osterwalder and company identify several flavors of segmentation: niche, segmented, diversified, and multi-sided. In a *niche* market, one or two very specialized segments to service are chosen. For example, one might choose to offer personalized services to very high-net worth individuals, or on the opposite end, offer highly discounted services to those who are less well-off.

[^4]: Osterwalder, Alexander, and Yves Pigneur, *Business Model Generation*, John Wiley & Sons, Hoboken, NJ: 2010.
...
![Value proposition canvas](media/a4edf749e1ed8f40e34993d74c6508ae.png)

Figure 3. Value Proposition Canvas (credit: Business Model Generation, 2010).
...
![Graphical user interface, table Description automatically generated](media/5c686f4143433da373097528d8a6178a.jpg)

Figure 4. Customer Journey Map Canvas.
