...
Version 3.0: Digital Transformation
![](image/image_.001.png)![](image/image_002.png)
...
![Creative Commons License](image/image_003.png) ITABoK 3.0 by [IASA](http://iasaglobal.org/) is licensed under a [Creative Commons Attribution-NonCommercial 4.0 International License](http://creativecommons.org/licenses/by-nc/4.0/). Based on a work at <https://www.iasaglobal.org/itabok3_0/>.


# Table of Contents
[What is Agility	3](#_Toc57032068)

[Why is Agility important	3](#_Toc57032069)

[Agility Approach	3](#_Toc57032070)

[Know the constraints	3](#_Toc57032071)

[Move at the right pace	4](#_Toc57032072)

[Customer centric	4](#_Toc57032073)

[Just in time and one at a time	4](#_Toc57032074)

[Automation is key	4](#_Toc57032075)

[Agile Methods	5](#_Toc57032076)

[Essential Agile	5](#_Toc57032077)

[Kanban	5](#_Toc57032078)

[Scrum	6](#_Toc57032079)

[SAFe (Scaled Agile Framework)	6](#_Toc57032080)

[Constraints on Agility	7](#_Toc57032081)

[Fixed contract business models	7](#_Toc57032082)

[Heavily regulated industries	8](#_Toc57032083)

[Culture and agile maturity	8](#_Toc57032084)

[Legacy systems	8](#_Toc57032085)

[Limited access to customer or sponsor	9](#_Toc57032086)

[Architecture and Agility	9](#_Toc57032087)

[References and further reading	11](#_Toc57032088)
...
|**DATE**|**COMMENT**|**AUTHOR**|
| :- | :- | :- |
|**2022-04-01**|<p>Some formatting changes in references section</p><p>Removed third-person text in some sections</p>|S Dougall|
||||
#
# What is Agility
*“ways of planning and doing work in which it is understood that making changes as they are needed is an important part of the job”* – Cambridge Dictionary, definition of Agility.
...
If we consider tThe “iron triangle” of project management we can see shows that there is a relation between cost, time and scope. The following scenarios apply:
...
A business culture is built up over many years and is often difficult to change. Assessing the agile maturity of a business is essential to ensuring that any new methods are a success. The pace of change to agile methods has to suit the ability of the organization to cope with the change. For example, businesses with little or no experience in agile methods have to be given time to adapt, and perhaps start with the basics before exposing the organization to more advanced concepts. Moving too quickly may lead to the organization resisting agile practices, and can result in disillusionment with the methods.

A key factor in promoting agile practices to the organization is to gain the trust of important stakeholders. This can help to drive changes in culture and promote the positive results of agile practices. The use of agile practices can then begin to grow naturally into the culture over time.
## Legacy systems
