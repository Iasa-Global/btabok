...
6.  Too few principles would make harder to trace the decisions back to requirements and also blurs the [scope](https://btabok.iasaglobal.org/btabok_3/scope-and-context/) of architecture
...
**[Agility](https://btabok.iasaglobal.org/btabok_3/digital-outcome-model/agility/) is key**
...
For a better understanding, architecture principles can be also organised in subsets (or categories): *Business*, *Application*, *Information*, *Technology* (see [TOGAF](http://pubs.opengroup.org/architecture/togaf9-doc/arch/chap23.html#tag_23_06) and an example from [University of Birmingham](https://intranet.birmingham.ac.uk/it/documents/public/architecture/Enterprise-Architecture-Principles.pdf))
