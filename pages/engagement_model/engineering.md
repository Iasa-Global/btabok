...
Engineering is a powerful branch of modern science and a set of deeply influential professions. It includes the world's electrical, mechanical, systems, and structural engineers and is a major area of study and application for architects as well. 
...
The BTABoK suggests explicitly measuring architecture practices on IBAM (see Getting Started and architecture practice articles). As a part of imagining the digital customer, there are three primary areas an organization can understand and lead the competition. It is about understanding the landscape in which customers interact in customer ecosystems. Customer journeys are about understanding all of the touchpoints of a customer with the company or around the company. In customer engagement, it is about understanding the customer.

## PRINCIPLE: Architecture and Systems Engineering Are Separate Professions
...
## PRINCIPLE: All Architects Must Have Deep Technology Skills In Their Background

One of the fundamental principles of the BTABoK is to stop ‘doing architecture.’ It means that the outcome of the work is more important than the method of achieving that outcome. Thus, using models, methods, techniques, and tools is the purview of any professional. Still, the digital customer and the company’s use of technology to engage that customer effectively is the outcome the architecture practice should be achieving.

## Architecture Practices Too Removed From Engineering Will Struggle for Success and Value
...
## PRINCIPLE: Engineers May Become Architects But Must Unlearn A Great Deal

The first rule of customer engagement is that it is about people. Real people are fallible, unreliable, illogical, and emotional. Their lives are busy. They have happy days and sad days. And empathy is the first step to truly understanding the cu

## Engineering and the Extended Team

Much is said about customers, but it is often difficult to know who the customer is as a person or who the real customer is. For example, while a particular person may sign the contract and approve Hi Dion
...
## 'uld be valuable to the architects and demonstrate them and their value.
...
## Metrics and Measurements in Engineering
...
[https://jtbd.info/2-what-is-jobs-to-be-done-jtbd-796b82081cca{:target="_blank"}](https://jtbd.info/2-what-is-jobs-to-be-done-jtbd-796b82081cca%7B:target="_blank"%7D)
