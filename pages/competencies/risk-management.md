...
toc: true
permalink: /competencies/risk-management.html
summary: Risk Management for architects involves identifying, evaluating, and mitigating risks that can negatively impact the value delivered by systems, projects, and strategies. While organizations often have centralized enterprise risk functions, architects play a key role in managing technical, strategic, and implementation risks. This includes anticipating failure modes, planning for uncertainty, and ensuring that architectural decisions align with both business goals and tolerance for risk. Effective architectural risk management enhances system resilience, supports informed decision-making, and aligns technical outcomes with enterprise priorities.
layout: page
tags:
...
| Probability/Impact | 1 | 2 | 3 | 4 | 5 | | 80-100% | Low | Medium | High | Extreme | Extreme | | 60-80% | Minimal | Low | Medium | High | Extreme | | 40-60% | Minimal | Low | Medium | High | High | | 20-40% | Minimal | Low | Low | Medium | High | | 0-20% | Minimal | Minimal | Low | Medium | High |
