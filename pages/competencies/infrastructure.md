...
toc: true
permalink: /competencies/infrastructure.html
summary: The Infrastructure Architecture specialization in the BTABoK addresses the foundational IT components—networks, compute, storage, platforms, and middleware—that support business applications and services. It emphasizes the architect’s role in ensuring that infrastructure decisions align with performance, reliability, scalability, and operational requirements. Core competencies include infrastructure awareness, system provisioning, capacity planning, quality attribute realization, and risk mitigation. Skilled infrastructure architects translate architectural requirements into infrastructure specifications and manage cross-cutting concerns such as security and availability. Learners can assess their skill by evaluating how effectively they integrate infrastructure considerations into architectural design and align infrastructure with business and technical needs.
layout: page
tags:
  - IT Environment
  - Core
...
**Elton Tucker***Enterprise Architect -- Microsoft*
