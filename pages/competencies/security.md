...
toc: true
permalink: /competencies/security.html
summary: Individual has experience architecting systems based on quality attribute requirements related to security. Individual has experience with trade-off analysis, developing models to capture, analyse and identify impacts of quality attributes. Individual has experience with the selection & implementation of technology based solutions based on analysis of security quality attributes. Individual has knowledge of and experience using threat modelling techniques.
layout: page
tags:
  - Quality Attributes
  - Core
