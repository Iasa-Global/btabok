...
toc: true
permalink: /competencies/business-views-and-models.html
summary: Business architecture uses a set of foundational views—Strategy, Value, Service, Capability, Process, and Financial—to describe the structure and dynamics of an organization. Each view leverages specific models such as strategy maps, value streams, capability maps, and experience maps to communicate business intent and enable alignment. Architects must understand when and how to apply these views to frame business problems, engage stakeholders, and support strategic transformation.
layout: page
tags:
...
Business architectures are built from a surprisingly small number of models that use a small number of building blocks and notations. These tools of business architecture, while fairly simple, are very powerful, able to express the architecture for any kind of business.
