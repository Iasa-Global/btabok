...
toc: true
permalink: /competencies/decomposition-and-reuse.html
summary: Individual has experience using various tools and methods to analyse and decompose complex systems into elements that are easy to understand, comprehend, explain, build and maintain. Experience building with reuse in mind and leveraging assets via reuse to deliver valuable services/solutions to the business
layout: page
tags:
  - Design
  - Core
