...
toc: true
permalink: /concepts/experiments.html
summary: Experiments in BTABoK are the architect’s mechanism for testing assumptions, exploring alternatives, and discovering new value across both business and technology domains. It is not limited to technical testing — experiments may evaluate business models, financing methods, team structures, meeting formats, or architectural strategies.  Mature architecture practices use experimentation to create a culture of measurable outcomes and validated learning. This capability helps organizations reduce risk, increase agility, and make informed investments through evidence, not guesswork.  Experiments can be lightweight or highly structured. What matters is that they’re intentional, measurable, and aligned with desired outcomes. When embedded across an architecture practice, they become a vehicle for continuous discovery and innovation at all levels of the organization.
layout: page
tags:
  - Operating Model
---
...
| **Type of Experiment** | **Description** | **Types of Measures** | | **Customer** | Customer experiments are those involving customer engagement, journeys and ecosystems. | Customer engagement, customer sentiment, brand recognition, jobs to be done. | | **Product** | Product experiments change features, access and other elements of a product. | Feature release utilization, product objectives and measures. | | **Operations** | Operational experiments are those that change capabilities, services and processes of an organization. | Operation efficiency, efficacy  and employee satisfaction. Lead times, value stream outcomes. | | **Stakeholders** | Stakeholder experiments are those that change the way stakeholders are managed. | Stakeholder sentiment, cultural outcomes, mindset and trusted advisor relationships. | | **Engagement Model** | Engagement model experiments are those that change the way the architects interact with the organization through deliverables, lifecycle, role or tools. | Architecture maturity, successful architecture engagements, stakeholder sentiment, architecture practice size and ratio. | | **Technology Operations** | Technology operations experiments are those that change the way technology is delivered to the organization and its customers. | Technology delivery, velocity, agility, safety and support. Quality attributes. | | **Measurement** | Measurement experiments are those that change how the organization understands its success and value. | Accuracy and timeliness. Culture, collaboration and mindset. Decisions, value management and technical debt. | | **Technology Structure** | Structural experiments include changes to services, partnerships, infrastructure or similar technology platforms, components and services. | Structural complexity, quality attributes and technical debt. Architecture analysis effectiveness. |

## # Supporting BTABoK Concepts & Canvases

-   Experiments Article (BTABoK)

-   [Investment Planning](https://iasa-global.github.io/btabok/investment_planning.html)

-   [Architecture Lifecycle](https://iasa-global.github.io/btabok/architecture_lifecycle.html)

-   \[Innovation and Strategy Articles\]
...
-   [Lean Startup (Eric Ries)](https://leanstartup.co/)

-   Hypothesis-Driven Development

-   Continuous Discovery Habits (Teresa Torres)

-   Amazon's Meeting Experiment

-   [Business Experimentation at Scale (Harvard)](https://hbr.org/2017/03/a-refresher-on-a-b-testing)
...
-   Include a "what assumption are we testing?" question in architectural decisions

-   Frame architecture alternatives as testable hypotheses with outcome goals

-   Run pilot programs for delivery methods, customer engagement, governance structures

-   Use lightweight metrics dashboards to monitor experimental initiatives

-   Align investment gates to learning outcomes, not just milestones

-   Embed architects into innovation labs or product discovery teams

-   Establish cross-functional councils to review and share experiment results
