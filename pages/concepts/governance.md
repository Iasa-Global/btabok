...
toc: true
permalink: /concepts/governance.html
summary: Governance in BTABoK is the system of structures, processes, and norms that ensures architecture supports the organization’s values, risk tolerance, and accountability needs. It is not about control, but about enabling consistent, ethical, and informed decision-making — especially in complex, regulated, or risk-sensitive environments.  Architecture governance guides the creation, evaluation, and compliance of architectures through a clear delegation of responsibility, accountability, and inspection methods. It creates transparency, encourages professionalism, and supports agility by offering predictability, clarity, and alignment — not bureaucracy.  Mature governance balances innovation and assurance, adapting to the organization’s tier (e.g., safety-critical vs. exploratory environments). Architects are typically governed, not governing, but they influence and inform how governance is shaped and applied across the architecture lifecycle.
layout: page
tags:
  - Operating Model
---
...
These norms, values, and policies may be specific to the organization and to the industry sector the organization is involved in or they may be more general. For example, organizations in strongly regulated business sectors are also likely to have strong governance frameworks, since the consequences of poor practices or decisions may be severe. Consider sectors such as the medical, pharmaceutical, energy, military or banking, where the consequences of poor [decisions](decisions.md){:target="_blank"} may result in loss of life, or substantial financial loss that leads to economic problems at a much higher scope. In the BTABoK [Safety and Liability](safety_liability.md) article these are labeled Tier 1 systems and result in a different governance implementation of the engagement model for architects.
...
Practicing good governance facilitates transparency. Inspections in the governance process raise issues, non-conformances and openly publish recommendations for resolutions. This provides support for the organization in maintaining standards and allows architects involved in different [assignments](assignment.md){:target="_blank"} to learn from recommendations which are openly discussed.
...
-   Governance Article (BTABoK)

-   [Architecture Lifecycle](https://iasa-global.github.io/btabok/architecture_lifecycle.html)

-   [Assignment and Accountability Models](https://iasa-global.github.io/btabok/assignment.html)

-   Safety and Liability

-   \[Architecture Boards and Reference Architectures\]
...
-   [TOGAF: Architecture Governance](https://pubs.opengroup.org/architecture/togaf9-doc/arch/chap44.html)

-   [COBIT](https://www.isaca.org/resources/cobit)

-   [ITIL Governance Principles](https://www.axelos.com/best-practice-solutions/itil)

-   [Institute on Governance](https://iog.ca/what-is-governance/)

-   [Chartered Governance Institute](https://www.cgi.org.uk/)
...
-   Co-design governance frameworks with stakeholders from business and IT

-   Use reference architectures to simplify compliance across solutions

-   Apply “bottom-up governance” by embedding traceability and validation in design

-   Separate architecture mentoring from inspection boards to avoid “police state” effects

-   Tailor governance models by system tier (e.g., safety-critical vs. agile)

-   Include governance feedback loops to improve over time

-   Align architecture principles to compliance and regulatory requirements

-   Develop inspection methods that validate process as well as outcome


# References and Further Reading

**Governance, what it is and why it is important -- Governance Today**[Governance](https://www.governancetoday.com/GT/Material/Governance__what_is_it_and_why_is_it_important_.aspx){:target="_blank"}

**What is governance -- Institute on Governance**[What is governance](https://iog.ca/what-is-governance/){:target="_blank"}

**What is governance -- Chartered Governance Institute UK and Ireland**[What is governance](https://www.cgi.org.uk/professional-development/discover-governance/looking-to-start-a-career-in-governance/what-is-governance){:target="_blank"}

**Architecture Governance (Chapter 44), TOGAF**[Architecture Governance](https://pubs.opengroup.org/architecture/togaf9-doc/arch/chap44.html){:target="_blank"}

**COBIT**[COBIT](https://www.isaca.org/resources/cobit){:target="_blank"}

**ITIL**[ITIL](https://www.axelos.com/best-practice-solutions/itil){:target="_blank"}
