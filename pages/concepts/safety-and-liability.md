...
toc: true
permalink: /concepts/safety-and-liability.html
summary: In a mature architecture practice, safety and liability are not just compliance obligations—they are professional imperatives. The practice proactively embeds safety considerations into architectural design, governance, and decision-making. It recognizes that architects hold accountability not only for technical correctness but also for the broader consequences of system failures. At high maturity, the practice helps define standards, validate risk controls, and shape organizational trust in technology outcomes.
layout: page
tags:
  - Outcome Model
---
...
**"Safety-critical system". encyclopedia.com**[Safety-critical system](http://www.encyclopedia.com/computing/dictionaries-thesauruses-pictures-and-press-releases/safety-critical-system){:target="_blank"}
...
**Iasa Global. "Ethical Guidelines".**[Iasa Global. "Ethical Guidelines"](https://iasa-global.github.io/btabok/ethics_and_principles.html){:target="_blank"}

**Iasa Global. "Training and Certification -- Professional"**[https://iasaglobal.org/Public/Learn/Certifications/Public/Learn/Training_and_Certifications.aspx?hkey=b18264af-a223-4a2e-a77c-053356d1a486](https://iasaglobal.org/Public/Learn/Certifications/Public/Learn/Training_and_Certifications.aspx?hkey=b18264af-a223-4a2e-a77c-053356d1a486)

**The Open Group, "Certified Architect (Open CA)"**\*\*[https://www.opengroup.org/certifications/certified-architect-open-ca](https://www.opengroup.org/certifications/certified-architect-open-ca)
