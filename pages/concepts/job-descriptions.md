...
toc: true
permalink: /concepts/job-descriptions.html
summary: |+
  Job descriptions define the scope, responsibilities, and required competencies of architects within an organization. Maturity in this area reflects the degree to which roles are clearly articulated, aligned with practice needs, integrated into HR and development processes, and continuously improved. High maturity ensures clarity in expectations, career paths, and value contribution for architecture roles.
