...
toc: true
permalink: /concepts/structural-complexity.html
summary: In a mature architecture practice, structural complexity is actively assessed, modeled, and addressed. The practice distinguishes between complicated and complex systems and adapts engagement strategies accordingly. Mature architects recognize that complexity isn’t just a design challenge—it’s a condition of modern systems, organizations, and ecosystems. They use framing tools, simulations, and engagement patterns to reduce confusion, increase coherence, and design for adaptability.
layout: page
tags:
  - Value Model
---
