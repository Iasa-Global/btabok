...
toc: true
permalink: /concepts/coverage.html
summary: Coverage refers to the extent to which architecture practices and influence are consistently applied across the enterprise. This includes domains, programs, geographies, and lifecycle phases — but critically, it also applies to the number and scope of architectural decisions, designs, and outcomes that require skilled architectural judgment. Mature architecture coverage ensures that architectural thinking is applied wherever high-impact decisions occur, rather than limited to certain teams or projects. Coverage maturity is reflected in how many strategic and tactical decisions are guided by qualified architects, and how successful those efforts are as a result.
layout: page
tags:
  - Value Model
---
