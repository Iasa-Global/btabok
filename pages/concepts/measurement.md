...
toc: true
permalink: /concepts/measurement.html
summary: Measurement in BTABoK is more than metrics — it is the cognitive and cultural foundation of architectural decision-making. To measure is to make sense of reality, to align on meaning, and to learn. Measurement defines the standards by which outcomes are recognized, trade-offs are assessed, and progress is interpreted. It is not inherently precise or objective — it is a shared agreement on what matters, how it should be evaluated, and why.  A mature measurement capability allows architecture to connect intent to evidence, action to value, and design to feedback. It supports not just performance management, but meaningful learning, transparency, and trust. It enables agility, innovation, and governance — because without shared measurements, we don’t know what worked, what didn’t, or why.  Measurement in BTABoK is a dialogue between people, data, and outcomes — a language that architects must help define, not just report on.
layout: page
tags:
  - Outcome Model
---

> "People think the free market is a philosophy; they believe it is a creed. It is none of those things. The free market is a bathroom scale; it is a measuring tape; it's simply a measurement." **P. J. O'Rourke**
...
-   \[Quality Attributes, Technical Debt, Outcome Metrics\]
...
-   [Measure What Matters – John Doerr (OKRs)](https://www.whatmatters.com/)

-   [Balanced Scorecard Institute (Kaplan & Norton)](https://balancedscorecard.org/)

-   [DORA Metrics & Accelerate](https://dora.dev/)

-   [MIT CISR – Measuring Architecture Value](https://cisr.mit.edu/)

-   [McKinsey – Business Measurement as Change Catalyst](https://www.mckinsey.com/)
...
-   Start with questions, not metrics — What do we need to learn?

-   Define measurement objectives per capability, outcome, or decision type

-   Use visual canvases and scorecards to socialize measurement logic

-   Embed KPIs, OKRs, and architecture signals in delivery governance

-   Track alignment, value flow, and stakeholder trust — not just delivery speed

-   Treat measures as experiments: adjust, debate, evolve

-   Create architectural "feedback objects" — dashboards, loops, sensors

-   Foster a measurement culture: shared meaning > perfect precisionReferences and Further Reading
