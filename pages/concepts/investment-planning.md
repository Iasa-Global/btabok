...
toc: true
permalink: /concepts/investment-planning.html
summary: Investment Planning in BTABoK is the architecture-led discipline of aligning technology decisions with organizational value creation through strategic funding, prioritization, and portfolio governance. It reframes IT and architecture as value-generating investments, not just operational costs.  This capability spans budgeting, business case development, benefit realization, risk trade-offs, and strategic foresight. Architects participate by identifying which capabilities, systems, or innovations should be funded — and when. Investment planning links strategy to delivery by focusing resources on high-value, mission-aligned change.  At maturity, architecture and finance work hand-in-hand to optimize investments across initiatives, platforms, outcomes, and innovation efforts. Architecture becomes a partner in steering where the organization bets its time, money, and capacity.
layout: page
tags:
  - Value Model
---

> "The placing of funds into the proper investment vehicles based on the investor's future goals, time horizon, and priorities. This also takes into account the safety of the investments \[..\]" **investorwords.com**
...
**TOGAF ADM**[TOGAF ADM](https://pubs.opengroup.org/architecture/togaf8-doc/arch/chap03.html){:target="_blank"}
...
-   [Investment Planning Article](https://iasa-global.github.io/btabok/investment_planning.html)

-   Business Case Canvas

-   Value Methods Canvas

-   [Strategy Scorecard Canvas](https://iasa-global.github.io/btabok/strategy_scorecard_canvas.html)
...
-   IT Investment Management Framework (US Federal)

-   \[Value Management Office (VMO) Practices – Gartner\]

-   [Technology Business Management (TBM)](https://www.tbmcouncil.org/)

-   [Beyond Budgeting – Bjarte Bogsnes](https://www.bbrt.org/)

-   McKinsey: Strategic Portfolio Management
...
-   Use value streams to structure investment decisions

-   Frame initiatives with measurable objectives and architectural criteria

-   Develop capability-based roadmaps to guide funding

-   Build repeatable business case frameworks tied to strategy and architecture

-   Create dashboards to track investment performance and benefit realization

-   Facilitate trade-off discussions between speed, risk, and return

-   Partner with finance to redefine IT as a portfolio of strategic assets

-   Incorporate experimentation results into future planning rounds
