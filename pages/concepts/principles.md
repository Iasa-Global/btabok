...
toc: true
permalink: /concepts/principles.html
summary: Architecture principles are codified beliefs and decision criteria that guide solution development, technology choices, and stakeholder trade-offs. Maturity in this area reflects how principles are developed, shared, understood, and applied throughout the organization. At high maturity, principles are actively used in decision-making, adapted based on context, and supported by education and governance mechanisms.
layout: page
tags:
  - Operating Model
---

> "A basic idea or rule that explains or controls how something happens or works" **Definition of Principle, Cambridge Dictionary**
...
**IT is an enabler**Statement: In the fast changing business context in which the company operates, where first-mover advantage is key, IT must support the business with a rapid path to production
