...
Wikipedia definition: In [computing](http://en.wikipedia.org/wiki/Computing), identity management (IdM) describes the management of individual [principals](http://en.wikipedia.org/wiki/Digital_identity), their [authentication, authorization](http://en.wikipedia.org/wiki/Access_control), and privileges within or across system and enterprise boundaries with the goal of increasing security and productivity while decreasing cost, downtime and repetitive tasks.
...
http://en.wikipedia.org/wiki/Identity\_management

https://msdn.microsoft.com/en-us/library/aa480030.aspx

> [Identity and Access Management – Capability Model](http://www.discoveringidentity.com/2013/03/08/identity-and-access-management-capability-model/)
...
> [Home](https://identitymanagementinstitute.org/)
